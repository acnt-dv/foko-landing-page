        ...
        <div className="flex flex-col xl:flex-row h-full xl:h-screen items-center justify-center">
            ...
            <div className='flex'>
                ...
                <span className="flex flex-col w-full justify-center items-center text-justify my-foko">
                    <p className="mx-[30px] xl:mx-[50px] text-10 xl:text-16 w-7/12 self-end xl:max-w-[450px]">FOKO Studio is a Los Angeles-based architecture and interior design firm.
                    ...
                    <p className="mx-[30px] xl:mx-[50px] hidden xl:block w-7/12 self-end text-16 max-w-[450px] my-foko">
                    ...
                    <h2 className="font-rubik w-7/12 xl:max-w-[450px] self-end mx-[30px] xl:mx-[50px] xl:justify-self-start text-10 xl:text-20 mt-foko">MORE &nbsp; &nbsp; &#62;</h2>
                </span>
            </div>

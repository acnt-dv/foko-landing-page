...
const AboutUs = () => {
    return (
        <div className="flex flex-col xl:flex-row h-full xl:h-screen items-center justify-center">
            <h1 className="text-start text-30 font-rubik hidden xl:block absolute left-[50px]">About <br/> FOKO</h1>

            <div className='flex'>
                <h1 className="text-16 font-rubik block xl:hidden absolute left-[30px] mt-foko">About <br/> FOKO</h1>
                <span className="flex flex-col w-full justify-start items-center text-justify my-foko xl:my-0">
                    <p className="mx-[30px] xl:mx-[50px] text-10 xl:text-16 w-7/12 self-end md:self-center max-w-[450px]">
                    ...
                    <h2 className="flex font-rubik w-7/12 max-w-[450px] self-end md:self-center mx-[30px] xl:mx-[50px] xl:justify-self-start text-10 xl:text-20 mt-foko">
                        MORE &nbsp; &nbsp; &nbsp;
                        <img src={right} alt="Right Image"/>
                    </h2>
                </span>
                <img src={aboutUsImage} alt={'aboutUsImage'}
                     className="hidden xl:block filter grayscale mb-foko xl:mx-foko"/>
            </div>
            <img src={aboutUsImage} alt={'aboutUsImage'}
                 className="block xl:hidden filter grayscale mb-foko xl:mx-foko"/>
        </div>)
}

...
const AboutUs = () => {
    return (
        <div className="flex flex-col xl:flex-row h-full xl:h-screen items-center justify-center">
            <h1 className="text-start text-lg hidden xl:block xl:text-30 absolute left-[50px] my-foko">About <br/> FOKO</h1>

            <div className='flex'>
                <h1 className="text-16 block xl:hidden absolute left-[30px] mt-foko">About <br/> FOKO</h1>
                <span className="flex flex-col w-full justify-center items-center text-justify my-foko">
                    <p className="mx-[30px] xl:mx-[50px] text-10 xl:text-16 max-w-[450px]">FOKO Studio is a Los Angeles-based architecture and interior design firm.
                    ...
                    <p className="mx-[30px] xl:mx-[50px] hidden xl:block text-16 max-w-[450px] my-foko">

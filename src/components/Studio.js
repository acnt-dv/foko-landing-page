...
const AboutUs = () => {
    return (
        <div className="flex flex-col w-full h-full items-center justify-center mt-[200px]">
            <div className="flex w-full">

                <div className="flex-col w-1/2 h-full items-center justify-center">
                    <div className='flex'>
                        <h1 className="text-16 font-rubik block absolute left-[30px] mt-foko">About <br/> FOKO
                        </h1>
                        <span className="flex flex-col w-full justify-center items-center text-justify my-foko">
                            <p className="mx-[30px] xl:mx-[50px] text-10 xl:text-16 w-1/2 self-end md:self-center ">FOKO Studio is a Los Angeles-based architecture and interior design firm.
                            ...
                            <p className="mx-[30px] xl:mx-[50px] hidden xl:block w-1/2 self-end md:self-center text-16  my-foko">
                    ...
                    <div className='flex'>
                        <h1 className="text-16 font-rubik block absolute left-[30px] mt-foko">OUR <br/> PHILOSOPHY
                        </h1>
                        <span className="flex flex-col w-full justify-center items-center text-justify my-foko">
                            <p className="mx-[30px] xl:mx-[50px] text-10 xl:text-16 w-1/2 self-end md:self-center">
                ...
                <div className="flex w-1/2">
                    <img src={aboutUsImage} alt={'aboutUsImage'} className="w-fit h-fit mb-foko xl:m-foko"/>
                </div>
            </div>
            <div className='flex w-full mb-[100px]'>
                <h1 className="text-16 font-rubik block xl:hidden absolute left-[30px] mt-foko">OUR <br/> TEAM</h1>
                <span className="flex flex-col w-full justify-center items-center text-justify my-foko">
                    <p className="mx-[30px] xl:mx-[50px] text-10 xl:text-16 w-9/12 self-end md:self-center">

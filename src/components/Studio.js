    ...
    return (
        <div className="flex flex-col w-full h-full items-center justify-center mt-[200px]">
                ...
                <div className="flex-col w-full md:w-1/2 h-full items-center justify-center">
                    <div className='flex'>
                        ...
                        <span className="flex flex-col w-full justify-center items-center text-justify my-foko">
                            ...
                            <p className="mx-[30px] xl:mx-[50px] w-1/2 self-end md:self-center text-10 xl:text-16  my-foko">
            ...
            <div className='flex w-full mb-[100px]'>
                <h1 className="text-16 font-rubik block absolute left-[30px] mt-foko">OUR <br/> TEAM</h1>
                <span className="flex flex-col w-full justify-center items-center text-justify my-foko">

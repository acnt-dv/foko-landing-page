        ...
        <div className="flex flex-col w-full h-full items-center justify-center mt-0 md:mt-[200px]">
            <div className="flex flex-col-reverse md:flex-row w-full">
                ...
                <div className="flex-col w-full md:w-1/2 h-full items-center justify-center">
                    <div className='flex'>
                        <h1 className="text-16 font-rubik block absolute left-[30px] text-left mt-[30px] xl:mt-foko">About <br/> FOKO
                        </h1>
                        <span className="flex flex-col w-full justify-center items-center text-justify my-[30px] xl:my-foko">
                    ...
                    <div className='flex'>
                        <h1 className="text-16 font-rubik block absolute left-[30px] text-left mt-foko">OUR <br/> PHILOSOPHY
                        </h1>
                ...
                <div className="flex w-full md:w-1/2">
                    <img src={aboutUsImage} alt={'aboutUsImage'} className="w-fit h-fit mb-0 xl:mb-foko xl:m-foko"/>
                </div>
            </div>
            <div className='flex w-full mb-[100px]'>
                ...
                <span className="flex flex-col w-full justify-center items-center text-justify my-foko">
                    <p className="mx-[30px] xl:mx-[50px] text-10 xl:text-16 w-1/2 md:w-9/12 self-end md:self-center">

...
const Works = () => {
    return (
        <div className="flex w-full h-screen items-center justify-center">
            <div className="flex flex-col w-1/6 h-3/4 border-r border-gray-500 justify-center items-start ml-foko bg-gradient-to-b from-black via-gray-100 to-gray-900 bg-clip-text text-transparent">
                <p>RESIDENTIAL</p>
                <p>COMMERCIAL</p>
                <p>ALL</p>
            </div>
            <div className="flex flex-col w-5/6 h-3/4">
                <div className="grid auto-cols-auto grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 p-4 w-full max-w-4xl overflow-auto">

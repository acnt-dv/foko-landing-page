const Contact = () => {
    return (
        <div className="flex flex-col xl:flex-row w-full h-screen justify-center items-center mb-32">
            ...
            <div className='flex w-full text-justify'>
                ...
                <p className="mx-[30px] xl:mx-[50px] w-full max-w-[450px] md:self-center text-10 xl:text-16">FOKO
